...
class Command
  getOptions: =>
    ...
    throw new Error MISSING_SERVICE_URL if _.isEmpty process.env.SLURRY_SALESFORCE_SERVICE_URL
    throw new Error MISSING_MANAGER_URL if _.isEmpty process.env.SLURRY_SALESFORCE_MANAGER_URL
    ...
    return {
      ...
      serviceUrl:      process.env.SLURRY_SALESFORCE_SERVICE_URL
      userDeviceManagerUrl: process.env.SLURRY_SALESFORCE_MANAGER_URL
      staticSchemasPath: process.env.SLURRY_SALESFORCE_STATIC_SCHEMAS_PATH
    }
